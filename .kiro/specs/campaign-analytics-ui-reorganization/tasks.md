...
- [ ] 3. 更新商户列表 UI
  ...
  - [ ] 3.3 更新 loadMerchantList 函数
    - 当选择"全部实例"时调用新 API
    - 当选择特定 Worker 时使用现有 API
    - _Requirements: 3.2, 3.3_

  - [ ] 3.4 更新 renderMerchants 函数
    - 根据筛选模式渲染不同的表格结构
    - 始终显示删除数据按钮（传递 workerName）
    - _Requirements: 4.1, 4.2, 4.3, 4.4_

  - [ ]* 3.5 编写 Worker 筛选属性测试
