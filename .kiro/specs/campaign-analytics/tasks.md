...
- [ ] 1. Set up database schema for campaign analytics
  - [ ] 1.1 Create migration script for campaign analytics tables
    - Add merchants, campaigns, campaign_emails, recipient_paths tables
    - Add all necessary indexes
    - _Requirements: 1.1, 1.2, 2.1, 4.1_
  - [ ] 1.2 Add TypeScript types for campaign analytics
...
- [ ] 2. Implement CampaignAnalyticsService core methods
  - [ ] 2.1 Implement domain extraction utility
    - Extract domain from email address
    - Handle edge cases (no @, multiple @, etc.)
    - _Requirements: 1.1_
  - [ ] 2.2 Write property test for domain extraction
    - **Property 1: Domain Extraction Consistency**
    - **Validates: Requirements 1.1**
  - [ ] 2.3 Implement merchant management methods
    - getMerchants, getMerchantByDomain, updateMerchant
    - Auto-create merchant on new domain
    - _Requirements: 1.2, 1.3, 1.4_
  - [ ] 2.4 Write property test for merchant auto-creation
    - **Property 2: Merchant Auto-Creation**
    - **Validates: Requirements 1.2**
  - [ ] 2.5 Implement campaign management methods
    - getCampaigns, getCampaignById, createOrUpdateCampaign
    - Subject hash calculation for fast lookup
    - _Requirements: 2.1, 2.2, 2.3, 2.4, 2.5_
  - [ ] 2.6 Write property test for campaign grouping
    - **Property 3: Campaign Grouping Invariant**
    - **Validates: Requirements 2.2**
  - [ ] 2.7 Write property test for email count consistency
...
- [ ] 4. Implement valuable campaign marking
  - [ ] 4.1 Implement markCampaignValuable method
    - Mark/unmark campaign as valuable
    - Store valuable note
    - _Requirements: 3.1, 3.2, 3.5_
  - [ ] 4.2 Write property test for valuable mark round-trip
    - **Property 5: Valuable Mark Round-Trip**
    - **Validates: Requirements 3.1, 3.2**
  - [ ] 4.3 Implement campaign filtering by valuable status
    - Add filter parameter to getCampaigns
    - _Requirements: 3.3, 3.4_
  - [ ] 4.4 Write property test for filter by valuable status
    - **Property 6: Filter by Valuable Status**
    - **Validates: Requirements 3.4**

- [ ] 5. Implement recipient path tracking
  - [ ] 5.1 Implement trackEmail method
    - Create/update merchant, campaign, path records
    - Handle duplicate emails in path
    - _Requirements: 4.1, 4.2, 4.3_
  - [ ] 5.2 Write property test for path chronological order
    - **Property 7: Path Chronological Order**
    - **Validates: Requirements 4.2**
  - [ ] 5.3 Write property test for path idempotence
    - **Property 8: Path Idempotence**
    - **Validates: Requirements 4.3**
  - [ ] 5.4 Implement getRecipientPath method
...
- [ ] 7. Implement campaign level analysis
  - [ ] 7.1 Implement getCampaignLevels method
    - Calculate level for each campaign based on paths
    - Handle campaigns appearing at multiple levels
    - _Requirements: 5.1, 5.2, 5.3, 5.4_
  - [ ] 7.2 Write property test for level calculation
    - **Property 9: Level Calculation Consistency**
    - **Validates: Requirements 5.2**

- [ ] 8. Implement campaign flow analysis
  - [ ] 8.1 Implement getCampaignFlow method
    - Calculate baseline population
    - Generate flow nodes and edges
    - Calculate percentages
    - _Requirements: 6.1, 6.2, 6.3, 6.4, 6.5_
  - [ ] 8.2 Write property test for baseline population
    - **Property 10: Baseline Population Accuracy**
    - **Validates: Requirements 6.1**
  - [ ] 8.3 Write property test for distribution ratio
...
- [ ] 10. Implement campaign analytics API routes
  - [ ] 10.1 Implement merchant API routes
    - GET /api/campaign/merchants
    - GET /api/campaign/merchants/:id
    - PUT /api/campaign/merchants/:id
    - _Requirements: 1.3, 1.4_
  - [ ] 10.2 Implement campaign API routes
  ...
  - [ ] 10.3 Implement track API routes
  ...
  - [ ] 10.5 Implement analysis API routes
...
- [ ] 12. Update Worker to report email data
  - [ ] 12.1 Add campaign tracking to email handler
